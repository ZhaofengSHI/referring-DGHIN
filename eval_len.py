...
def evaluate(net, dataset):
    ...
    try:
        ...
        # Print results
        print('\nSegmentation evaluation (different length):')
        result_str = ''

        result_str += 'overall IoU of different length = \n'
        result_str += 'length range 1 = %f\n' % (cum_I_1 / cum_U_1)
        result_str += 'overall I = %f\n' % cum_I_1
        result_str += 'overall U = %f\n' % cum_U_1

        result_str += 'length range 2 = %f\n' % (cum_I_2 / cum_U_2)
        result_str += 'overall I = %f\n' % cum_I_2
        result_str += 'overall U = %f\n' % cum_U_2

        result_str += 'length range 3 = %f\n' % (cum_I_3 / cum_U_3)
        result_str += 'overall I = %f\n' % cum_I_3
        result_str += 'overall U = %f\n' % cum_U_3

        result_str += 'length range 4 = %f\n' % (cum_I_4 / cum_U_4)
        result_str += 'overall I = %f\n' % cum_I_4
        result_str += 'overall U = %f\n' % cum_U_4
